      ...
      <div className="w-full max-w-md max-h-[90vh] overflow-y-auto">
        <Card className="border-0 shadow-2xl bg-white relative">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-4 border-b border-gray-200">
            <div>
              <CardTitle className="text-xl font-semibold text-gray-900">Tambah Siswa Baru</CardTitle>
              <CardDescription className="text-gray-600">Masukkan informasi siswa baru</CardDescription>
            </div>
            <Button 
              variant="ghost" 
              size="sm" 
